 ...
 *  @author User
 */
public class Canvas extends com.codename1.ui.Label {
	 ...
	 */
	public void setPreviousKeyboardState(input.KeyboardState previousKeyboardState) {
	}
	 ...
	 */
	public void setCurrentKeyboardState(input.KeyboardState currentKeyboardState) {
	}
	 ...
	 */
	public void setPreviousTouchPanelState(input.TouchPanelState previousTouchPanelState) {
	}
	 ...
	 */
	public void setCurrentTouchPanelState(input.TouchPanelState currentTouchPanelState) {
	}
	 ...
	 */
	public void setPreviousScreenpadState(input.ScreenpadState previousScreenpadState) {
	}
	 ...
	 */
	public void setCurrentScreenpadState(input.ScreenpadState currentScreenpadState) {
	}
